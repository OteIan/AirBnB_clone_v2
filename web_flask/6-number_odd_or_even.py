...
\t\t\tprovided integer 'n'
7. '/number_odd_or_even/<int:n>' - Renders an HTML template indicating
\t\t\twhether the provided integer 'n' is odd or even.
"""
...
def number_odd_or_even(n):
    ...
    Renders an HTML template indicating whether the provided integer
    'n' is odd or even.

    Example:
    $ curl http://127.0.0.1:5000/number_odd_or_even/89
    Output: HTML page displaying "Number: 89 is even"
    """
